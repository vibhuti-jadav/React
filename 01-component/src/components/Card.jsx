...
const Card = () => {
  return (
    <div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-28 gap-4 mx-auto'>
...
<div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700 my-5">
